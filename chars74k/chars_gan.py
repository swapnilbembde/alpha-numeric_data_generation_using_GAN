...
if not os.path.isdir('chars_results'):
    os.mkdir('chars_results')
if not os.path.isdir('chars_results/images'):
    os.mkdir('chars_results/images')
...
for epoch in range(epochs):
    ...
    p = 'chars_results/images/' + str(epoch + 1)+ '.png'
...
loss_plots(train_hist, save=False, path='chars_results/MNIST_GAN_train_hist.png')
torch.save(G.state_dict(), "chars_results/generator_param.pkl")
torch.save(D.state_dict(), "chars_results/discriminator_param.pkl")
with open('chars_results/train_hist.pkl', 'wb') as f:
    pickle.dump(train_hist, f)

# creating gif file     
images = []
for i in range(epochs):
    img_name = 'chars_results/images/' + str(i + 1) + '.png'
    images.append(imageio.imread(img_name))
imageio.mimsave('chars_results/gif_file.gif', images, fps=5)
